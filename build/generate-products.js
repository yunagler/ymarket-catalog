 ...
 * Creates SEO-optimized pages in /products/ directory
 *
 * Usage: node build/generate-products.js
 *
 * Requires: data/products.json (generated by export-catalog.js)
 */
  ...
  const relatedHtml = related.map(p => `
    <div class="product-card" style="min-width: 220px;">
      ...
      <div class="product-card__body">
        <h3 class="product-card__name"><a href="${p.slug}.html">${p.name}</a></h3>
...
function main() {
  ...
  if (!fs.existsSync(DATA_PATH)) {
    ...
    console.log('Run export-catalog.js first to generate the products data.');
    process.exit(1);
  }
